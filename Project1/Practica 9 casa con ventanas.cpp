...
void prisma4(GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
...
void prisma5(GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
...
//Muro Izquierdo
	glPushMatrix();
		...
		prisma4(ventana.GLindex, muro.GLindex);
...
//Muro Derecho
	glPushMatrix();
		...
		glEnable(GL_ALPHA_TEST);
		glAlphaFunc(GL_GREATER, 0.1);
		prisma5(ventana.GLindex, viga.GLindex);
		glDisable(GL_ALPHA_TEST);
	glPopMatrix();
